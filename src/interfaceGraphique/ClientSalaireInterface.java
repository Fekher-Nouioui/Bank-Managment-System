...
public class ClientSalaireInterface extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClientSalaireInterface frame = new ClientSalaireInterface();
	...
	public ClientSalaireInterface() {
		...
		JLabel bienvenueJLabel = new JLabel("Bienvenue dans votre Compte de Salaire");
		...
		virementPanel.setBounds(112, 36, 648, 537);
		...
		infosComptePanel.setBounds(213, 22, 570, 569);
		...
		lblVotreRib.setBounds(22, 427, 129, 36);
		...
		voirInfoJLabel.setBounds(250, 529, 203, 30);
